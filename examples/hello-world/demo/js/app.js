...
(function( root, factory ) {
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.hello_world.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "hello-world.wasm" );
        ...
        const __promise = fetch( "hello-world.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'hello_world'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'hello_world':", error );
                throw error;
            });

        Rust.hello_world = __promise;
        return __promise;
    }
}));
